...
public class TCKCacheConfiguration<K, V> implements CacheConfiguration<K, V> {
    ...
    /**
     * Specifies that a listener should be registered for a {@link Cache} when
     * this {@link CacheConfiguration} is used to configure a {@link Cache}.
     *
     * @param cacheEntryListener the listener to add for later registration
	 * @return the {@link TCKCacheConfiguration}
     * @throws NullPointerException if any of the arguments are null.
     */
	public TCKCacheConfiguration<K, V> addCacheEntryListener(CacheEntryListener<? super K, ? super V> cacheEntryListener) {
